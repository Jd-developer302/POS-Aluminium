...
export default function AuthenticatedSidebar({ mobileDrawerOpen, showCollapsed }) {
    ...
    return (
        <aside
            className={`fixed left-0 top-0 z-40 flex h-screen w-64 flex-col border-r border-gray-200 bg-white text-gray-900 shadow-lg transition-all duration-layout ease-out ${
            ...
            >
                ...
                >
                    ...
                    {!showCollapsed && !branding?.logo_large_url ? (
                        <span className="text-lg font-semibold tracking-tight text-gray-900 transition-opacity duration-layout">
                            {appName}
                        </span>
                    ) : null}
                    ...
                    {showCollapsed && !branding?.logo_small_url ? (
                        <span className="hidden text-lg font-bold text-gray-900 lg:inline">
                            {appName.charAt(0)}
                        </span>
                    ) : null}
                </div>
