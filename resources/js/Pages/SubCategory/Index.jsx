                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                            Under a category — URLs use slug
                        </p>
                    </div>
                    {perms.includes('sub_categories.create') && (
                        <Link
                                            ...
                                            <div className="inline-flex items-center justify-end gap-1.5">
                                                {perms.includes(
                                                    ...
                                                    <Link
                                                        ...
                                                        title="View"
                                                        aria-label={`View subcategory ${row.name}`}
                                                ...
                                                {perms.includes(
                                                    ...
                                                    <Link
                                                        ...
                                                        title="Edit"
                                                        aria-label={`Edit subcategory ${row.name}`}
                                                ...
                                                {perms.includes(
                                                    ...
                                                    <button
                                                        type="button"
                                                        title="Delete"
                                                        aria-label={`Delete subcategory ${row.name}`}
                                                        onClick={() =>
                                                            destroy(
                                                                row.slug,
                                                                row.name,
