...
export default function Index({ designations, branches, departments, filters: filtersProp }) {
    ...
    const clearFilters = () => {
        setData({ branch_id: '', department_id: '', status: '', q: '' });
            ...
            header={
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-500">Job titles linked to departments</p>
                    </div>
                    ...
                    <table className="min-w-full divide-y divide-gray-200 text-sm">
                        <thead className="bg-gray-50">
                            <tr>
                                ...
                                <th className="px-4 py-3 text-start font-semibold text-gray-700">Department</th>
                                    ...
                                    <tr key={row.id} className="hover:bg-gray-50/80">
                                        ...
                                        <td className="px-4 py-3 text-end">
                                            <div className="inline-flex items-center justify-end gap-1.5">
                                                <Link
                                                    href={route('designations.edit', row.slug)}
                                                    title="Edit"
