...
export default function Index({ leaveTypes, filters: filtersProp }) {
    ...
    const applyFilters = (e) => {
        e.preventDefault();
        get(route('leave-types.index'), { preserveState: true });
    };
            ...
            header={
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-500">Policies, yearly days, and paid / unpaid</p>
                    </div>
                    <Link
                    ...
                    <table className="min-w-full divide-y divide-gray-200 text-sm">
                        <thead className="bg-gray-50">
                            <tr>
                                ...
                                <th className="px-4 py-3 text-start font-semibold text-gray-700">Days / year</th>
                                <th className="px-4 py-3 text-start font-semibold text-gray-700">Paid</th>
                            ...
                            {leaveTypes.data.length === 0 ? (
                                ...
                                leaveTypes.data.map((row) => (
                                    <tr key={row.id} className="hover:bg-gray-50/80">
                                        ...
                                        <td className="px-4 py-3 text-gray-700">{row.days_per_year}</td>
                                        ...
                                        <td className="px-4 py-3 text-end">
                                            <div className="inline-flex items-center justify-end gap-1.5">
                                                <Link
                                                    href={route('leave-types.edit', row.slug)}
                                                    title="Edit"
