                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                            Measurement units for products (e.g. kg, piece). Slug is
                            generated from the name.
                        </p>
                    </div>
                    {perms.includes('units.create') && (
                        <Link
                                    ...
                                    <tr key={u.id} className="hover:bg-gray-50/80">
                                        ...
                                        <td className="px-4 py-3 text-end">
                                            <div className="inline-flex items-center justify-end gap-1.5">
                                                {perms.includes('units.view') && (
                                                    <Link
                                                        href={route('units.show', u.slug)}
                                                        title="View"
                                                        aria-label={`View unit ${u.name}`}
                                                ...
                                                {perms.includes('units.delete') && (
                                                    <button
                                                        type="button"
                                                        title="Delete"
                                                        aria-label={`Delete unit ${u.name}`}
                                                        onClick={() => destroy(u.slug, u.name)}
